...
bool UBTDecorator_HasLoSTo::LOSTrace(AActor* InActor, AActor* InEnemyActor, const FVector& EndLocation) const
{
	...
	ACyberBotAIController* MyController = Cast<ACyberBotAIController>(InActor);
	ACyberPirateBot* MyBot = MyController ? Cast<ACyberPirateBot>(MyController->GetPawn()) : NULL;
