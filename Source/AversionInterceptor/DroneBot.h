 ...
 */
UCLASS(ABSTRACT)
class AVERSIONINTERCEPTOR_API ADroneBot : public AAversionInterceptorCharacter
{
	GENERATED_BODY()
...
public:
	...
	ADroneBot(const class FObjectInitializer& ObjectInitializer);
