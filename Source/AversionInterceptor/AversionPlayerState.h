...
#include "AversionPlayerState.generated.h"

/**
 * 
 */
UCLASS()
class AVERSIONINTERCEPTOR_API AAversionPlayerState : public APlayerState
{
	...
	*/
	...
	void ScoreKill(AAversionPlayerState* Victim, int32 Points);

	/** player died */
	void ScoreDeath(AAversionPlayerState* KilledBy, int32 Points);
	...
	UFUNCTION(Reliable, Client)
		void InformAboutKill(class AAversionPlayerState* KillerPlayerState, const UDamageType* KillerDamageType, class AAversionPlayerState* KilledPlayerState);

	/** broadcast death to local clients */
	UFUNCTION(Reliable, NetMulticast)
		void BroadcastDeath(class AAversionPlayerState* KillerPlayerState, const UDamageType* KillerDamageType, class AAversionPlayerState* KilledPlayerState);
