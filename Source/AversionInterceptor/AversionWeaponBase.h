...
class AVERSIONINTERCEPTOR_API AAversionWeaponBase : public AActor
{
	...
	virtual void OnEquip(const AAversionWeaponBase* LastWeapon);
	...
	class AAversionInterceptorCharacter* GetPawnOwner() const;
	...
	void SetOwningPawn(AAversionInterceptorCharacter* AShooterCharacter);
...
protected:
	...
	class AAversionInterceptorCharacter* MyPawn;
