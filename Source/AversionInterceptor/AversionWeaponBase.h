...
#include "AversionWeaponBase.generated.h"
...
class AVERSIONINTERCEPTOR_API AAversionWeaponBase : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	AAversionWeaponBase(const FObjectInitializer& ObjectInitializer);
	...
	class AInterceptorCharacter* MyPawn;
...
public:
	...
	void SetOwningPawn(AInterceptorCharacter* NewOwner);

	/* Get pawn owner */
	UFUNCTION(BlueprintCallable, Category = "Weapon")
	class AInterceptorCharacter* GetPawnOwner() const;

	virtual void OnEnterInventory(AInterceptorCharacter* NewOwner);
...
protected:
	...
	virtual void FireWeapon() PURE_VIRTUAL(AAversionWeaponBase::FireWeapon, );
